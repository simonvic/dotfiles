...
function M.build_groups(palette)
	...
	local groups = {
		...
		Cursor                             = { bg = p.zdepth_0, fg = p.text__1 },
		lCursor                            = { link = "Cursor" },
		...
		------------------------------------------------------------------------ diff
		Added                              = { bg = p.added__3, },
		Changed                            = { bg = p.changed__3, },
		Removed                            = { bg = p.deleted__3, },
		...
		GitSignsAddPreview                 = { bg = p.added__3 },
		GitSignsDeletePreview              = { bg = p.deleted__3 },
		GitSignsAddNr                      = { bg = p.added__3 },
		GitSignsChangeNr                   = { bg = p.changed__3 },
		GitSignsDeleteNr                   = { bg = p.deleted__3 },
		GitSignsAddLn                      = { link = "GitSignsAddNr" },
		GitSignsChangeLn                   = { link = "GitSignsChangeNr" },
		GitSignsDeleteLn                   = { link = "GitSignsDeleteNr" },
		GitSignsAddCul                     = { link = "GitSignsAddNr" },
		GitSignsChangeCul                  = { link = "GitSignsChangeNr" },
		GitSignsDeleteCul                  = { link = "GitSignsDeleteNr" },
		GitSignsStagedAdd                  = { bg = p.zdepth_1, fg = p.added__2 },
		GitSignsStagedChange               = { bg = p.zdepth_1, fg = p.changed__2 },
		GitSignsStagedDelete               = { bg = p.zdepth_1, fg = p.deleted__2 },
		GitSignsStagedAddNr                = { bg = p.added__3 },
		GitSignsStagedChangeNr             = { bg = p.changed__3 },
		GitSignsStagedDeleteNr             = { bg = p.deleted__3 },
		GitSignsStagedAddLn                = { link = "GitSignsStagedAddNr" },
		GitSignsStagedChangeLn             = { link = "GitSignsStagedChangeNr" },
		GitSignsStagedDeleteLn             = { link = "GitSignsStagedDeleteNr" },
		GitSignsStagedAddCul               = { link = "GitSignsStagedAddNr" },
		GitSignsStagedChangeCul            = { link = "GitSignsStagedChangeNr" },
		GitSignsStagedDeleteCul            = { link = "GitSignsStagedDeleteNr" },
		...
		LspKindArray                       = { link = "@variable" },
		LspKindObject                      = { link = "@variable" },
		LspKindKey                         = { link = "@property" },
		LspKindNull                        = { link = "@constant.builtin" },
		LspKindEnumMember                  = { link = "@variable.member" },
		LspKindStruct                      = { link = "Type" },
		LspKindEvent                       = { link = "Type" },
		LspKindOperator                    = { link = "@operator" },
		LspKindTypeParameter               = { link = "Type" },
		...
		BlinkCmpKind                       = { link = "LspKind" },
		BlinkCmpKindFile                   = { link = "LspKindFile" },
		BlinkCmpKindModule                 = { link = "LspKindModule" },
		BlinkCmpKindNamespace              = { link = "LspKindNamespace" },
		BlinkCmpKindPackage                = { link = "LspKindPackage" },
		BlinkCmpKindClass                  = { link = "LspKindClass" },
		BlinkCmpKindMethod                 = { link = "LspKindMethod" },
		BlinkCmpKindProperty               = { link = "LspKindProperty" },
		BlinkCmpKindField                  = { link = "LspKindField" },
		BlinkCmpKindConstructor            = { link = "LspKindConstructor" },
		BlinkCmpKindEnum                   = { link = "LspKindEnum" },
		BlinkCmpKindInterface              = { link = "LspKindInterface" },
		BlinkCmpKindFunction               = { link = "LspKindFunction" },
		BlinkCmpKindVariable               = { link = "LspKindVariable" },
		BlinkCmpKindConstant               = { link = "LspKindConstant" },
		BlinkCmpKindString                 = { link = "LspKindString" },
		BlinkCmpKindNumber                 = { link = "LspKindNumber" },
		BlinkCmpKindBoolean                = { link = "LspKindBoolean" },
		BlinkCmpKindArray                  = { link = "LspKindArray" },
		BlinkCmpKindObject                 = { link = "LspKindObject" },
		BlinkCmpKindKey                    = { link = "LspKindKey" },
		BlinkCmpKindNull                   = { link = "LspKindNull" },
		BlinkCmpKindEnumMember             = { link = "LspKindEnumMember" },
		BlinkCmpKindStruct                 = { link = "LspKindStruct" },
		BlinkCmpKindEvent                  = { link = "LspKindEvent" },
		BlinkCmpKindOperator               = { link = "LspKindOperator" },
		BlinkCmpKindTypeParameter          = { link = "LspKindTypeParameter" },

		------------------------------------------------------------------------ Aerial
		AerialFile                         = { link = "LspKindFile" },
		AerialModule                       = { link = "LspKindModule" },
		AerialNamespace                    = { link = "LspKindNamespace" },
		AerialPackage                      = { link = "LspKindPackage" },
		AerialClass                        = { link = "LspKindClass" },
