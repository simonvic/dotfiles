...
M.fn                 = {
	...
	find_references             = vim.lsp.buf.references,
...
M.mappings           = {
	...
	{ n___, { "<C-b>", "gd" },                    function() M.fn.goto_definition() end,           { desc = "Go to definition" } },
	{ __i_, "<C-b>",                              function() M.fn.goto_definition() end,           { desc = "Go to definition" } },
	{ n___, { "<A-r>", "gr" },                    function() M.fn.find_references() end,           { desc = "Find references" } },
	{ __i_, "<A-r>",                              function() M.fn.find_references() end,           { desc = "Find references" } },
	...
	{ nv__, "<leader>cc",                         "gcc",                                           { desc = "Comment toggle" } },
