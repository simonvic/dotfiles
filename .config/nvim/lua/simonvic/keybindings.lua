...
local keybindings = {
	...
	---------------------------------------------------------------------------- SELECTION
	{ n___, "<S-LEFT>",         "v<LEFT>",                              { desc = "Left" } },
	{ _v__, "<S-LEFT>",         "<LEFT>",                               { desc = "Left" } },
	{ __i_, "<S-LEFT>",         "<LEFT><C-o>v",                         { desc = "Left" } },
	{ n___, "<S-RIGHT>",        "v<RIGHT>",                             { desc = "Right" } },
	{ _v__, "<S-RIGHT>",        "<RIGHT>",                              { desc = "Right" } },
	{ __i_, "<S-RIGHT>",        "<C-o>v",                               { desc = "Right" } },
	{ n___, "<S-UP>",           "v<UP>",                                { desc = "Up" } },
	{ _v__, "<S-UP>",           "<UP>",                                 { desc = "Up" } },
	{ __i_, "<S-UP>",           "<LEFT><C-o>v<UP><RIGHT>",              { desc = "Up" } },
	{ n___, "<S-DOWN>",         "v<DOWN>",                              { desc = "Down" } },
	{ _v__, "<S-DOWN>",         "<DOWN>",                               { desc = "Down" } },
	{ __i_, "<S-DOWN>",         "<C-o>v<DOWN><LEFT>",                   { desc = "Down" } },
	{ n___, "<S-C-LEFT>",       "vb",                                   { desc = "Word left" } },
	{ _v__, "<S-C-LEFT>",       "b",                                    { desc = "Word left" } },
	{ __i_, "<S-C-LEFT>",       "<LEFT><C-o>vb",                        { desc = "Word left" } },
	{ n___, "<S-C-RIGHT>",      "ve",                                   { desc = "Word right" } },
	{ _v__, "<S-C-RIGHT>",      "e",                                    { desc = "Word right" } },
	{ __i_, "<S-C-RIGHT>",      "<C-o>ve",                              { desc = "Word right" } },
	{ n___, "<S-HOME>",         "v^",                                   { desc = "To first character" } },
	{ _v__, "<S-HOME>",         "^",                                    { desc = "To first character" } },
	{ __i_, "<S-HOME>",         "<LEFT><C-o>v^",                        { desc = "To first character" } },
	{ n___, "<S-A-HOME>",       "v0",                                   { desc = "To start of line" } },
	{ _v__, "<S-A-HOME>",       "0",                                    { desc = "To start of line" } },
	{ __i_, "<S-A-HOME>",       "<LEFT><C-o>v0",                        { desc = "To start of line" } },
	{ n___, "<S-END>",          "vg_",                                  { desc = "To last character" } },
	{ _v__, "<S-END>",          "g_",                                   { desc = "To last character" } },
	{ __i_, "<S-END>",          "<C-o>vg_",                             { desc = "To last character" } },
	{ n___, "<S-A-END>",        "v$",                                   { desc = "To end of line" } },
	{ _v__, "<S-A-END>",        "$",                                    { desc = "To end of line" } },
	{ __i_, "<S-A-END>",        "<C-o>v$",                              { desc = "To end of line" } },
	{ n___, "<S-C-HOME>",       "vgg0",                                 { desc = "To start of file" } },
	{ _v__, "<S-C-HOME>",       "gg0",                                  { desc = "To start of file" } },
	{ __i_, "<S-C-HOME>",       "<LEFT><C-o>vgg0",                      { desc = "To start of file" } },
	{ n___, "<S-C-END>",        "vG$",                                  { desc = "To end of file" } },
	{ _v__, "<S-C-END>",        "G$",                                   { desc = "To end of file" } },
	{ __i_, "<S-C-END>",        "<C-o>vG$",                             { desc = "To end of file" } },
	---------------------------------------------------------------------------- EDITING
	{ n_i_, "<C-A-DOWN>",       cmd("move +1"),                         { desc = "Move down", silent = true } },
	{ n___, "<leader>JJ",       cmd("move +1"),                         { desc = "Move down", silent = true } },
	{ _v__, "<C-A-DOWN>",       ":move '>+1<CR>gv",                     { desc = "Move down", silent = true } },
	{ _v__, "<leader>JJ",       ":move '>+1<CR>gv",                     { desc = "Move down", silent = true } },
	{ n_i_, "<C-A-UP>",         cmd("move -2"),                         { desc = "Move up", silent = true } },
	{ n___, "<leader>KK",       cmd("move -2"),                         { desc = "Move up", silent = true } },
	{ _v__, "<C-A-UP>",         ":move '<-2<CR>gv",                     { desc = "Move up", silent = true } },
	{ _v__, "<leader>KK",       ":move '<-2<CR>gv",                     { desc = "Move up", silent = true } },
	{ n_i_, "<C-S-DOWN>",       cmd("copy +0"),                         { desc = "Copy down", silent = true } },
	{ n___, "<leader>jj",       cmd("copy +0"),                         { desc = "Copy down", silent = true } },
	{ _v__, "<C-S-DOWN>",       ":copy '<-1<CR>gv",                     { desc = "Copy down", silent = true } },
	{ _v__, "<leader>jj",       ":copy '<-1<CR>gv",                     { desc = "Copy down", silent = true } },
	{ n_i_, "<C-S-UP>",         cmd("copy -1"),                         { desc = "Copy up", silent = true } },
	{ n___, "<C-S-UP>",         cmd("copy -1"),                         { desc = "Copy up", silent = true } },
	{ n___, "<leader>kk",       cmd("copy -1"),                         { desc = "Copy up", silent = true } },
	{ _v__, "<C-S-UP>",         ":copy '>+0<CR>gv",                     { desc = "Copy up", silent = true } },
	{ _v__, "<leader>kk",       ":copy '<-1<CR>gv",                     { desc = "Copy down", silent = true } },
	...
	---------------------------------------------------------------------------- WINDOWS
	{ n_it, "<A-LEFT>",         cmd("wincmd h"),                        { desc = "Focus left window" } },
	{ n_it, "<A-DOWN>",         cmd("wincmd j"),                        { desc = "Focus down window" } },
	{ n_it, "<A-UP>",           cmd("wincmd k"),                        { desc = "Focus up window" } },
	{ n_it, "<A-RIGHT>",        cmd("wincmd l"),                        { desc = "Focus right window" } },
	{ n_i_, "<A-S-LEFT>",       cmd("wincmd H"),                        { desc = "Move left" } },
	{ n_i_, "<A-S-DOWN>",       cmd("wincmd J"),                        { desc = "Move down" } },
	{ n_i_, "<A-S-UP>",         cmd("wincmd K"),                        { desc = "Move up" } },
	{ n_i_, "<A-S-RIGHT>",      cmd("wincmd L"),                        { desc = "Move right" } },
	...
	---------------------------------------------------------------------------- UI
	{ n___, "<Leader>ud",       toggle_dapUI,                           { desc = "Dapui" } },
	...
	{ nvi_, "<A-9>",            cmd("AerialToggle"),                    { desc = "Symbols outline" } },
	{ nvi_, "<A-)>",            cmd("AerialNavToggle"),                 { desc = "Symbols outline floating navigation" } },
	{ n___, "<leader>S",        cmd("AerialNavToggle"),                 { desc = "Symbols outline floating navigation" } },
	---------------------------------------------------------------------------- DEBUGGING
	{ n___, "<F7>",             cmd("DapContinue"),                     { desc = "Continue [F7]" } },
	{ n___, "<F55>",            cmd("DapTerminate"),                    { desc = "Terminate [Alt + F7]" } },
	{ n___, "<F19>",            dap_run_last,                           { desc = "Run last [Shift + F7]" } },
	{ n___, "<F8>",             cmd("DapStepOver"),                     { desc = "Step over[F8]" } },
	{ n___, "<F32>",            cmd("DapStepInto"),                     { desc = "Step into [Ctrl + F8]" } },
	{ n___, "<F20>",            cmd("DapStepOut"),                      { desc = "Step out [Shift + F8]" } },
	{ n___, "<F9>",             cmd("DapToggleBreakpoint"),             { desc = "Breakpoint [F9]" } },
	{ n___, "<F33>",            breakpoint_condition,                   { desc = "Conditional breakpoint [Ctrl + F9]" } },
	{ n___, "<F57>",            breakpoing_log,                         { desc = "Log breakpoint [Alt + F9]" } },
	{ n___, "<F21>",            breapoint_condition_log,                { desc = "Conditional log breakpoint [Shift + F9]" } },
	{ n___, "<A-q>",            inspect_variable,                       { desc = "Inspect variable" } },
	---------------------------------------------------------------------------- PLUGINS
	plugins = {
		------------------------------------------------------------------------ TREESITTER
		treesitter         = {
