...
M.mappings = {
	...
	{ n___, "<Leader>uZ",                         function() M.fn.zen_mode() end,                  { desc = "Toggle zen mode" } },
...
M.plugins.nvimtree = {
	...
	{ n___, "H",                 function() require("nvim-tree.api").filter.dotfiles.toggle() end,         { desc = "Toggle Filter: Dotfiles" } },
	{ n___, "I",                 function() require("nvim-tree.api").filter.git.ignored.toggle() end,      { desc = "Toggle Filter: Git Ignore" } },
